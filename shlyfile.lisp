...
(load "patriothackers-cl.asd")
(load "postmodern-localtime.asd")

(ql:quickload '(:patriothackers-cl :split-sequence))
...
(defun start (&key (port 50000)
                   (server :wookie)
                   (debug nil))
  (flet ((start (&rest args)
           (apply #'patriothackers-cl:start
